...
(async () => {
    ...
    await page.fill('#wzUserContact', '081200000001');
    await page.fill('#wzSupervisor', 'Pak Rian Kusuma');
    ...
    // Test Siswa Login
    await page.click('.demo-pill[data-nis="000002"]');
    await sleep(300);
    ...
    await page.goto('http://localhost:8080/login/login.html');
    await sleep(500);
    await page.click('.demo-pill[data-nis="00000000"]');
    await sleep(300);
    await page.click('#signInForm button[type="submit"]');
    await sleep(1000);
    await page.click('#navAdminSuiteBtn');

    ...
    function openSlipModal(bookingId) {
        ...
        printableSlip.innerHTML = `
            ...
            <table class="letter-meta-table">
                ...
                <tr><td><strong>Guru Pendamping</strong></td><td>:</td><td>${b.supervisorName || 'Pak Arif Nugroho, S.Kom'}</td></tr>
            ...
            <div class="letter-signature-grid">
                ...
                <div>
                    ...
                    <div class="letter-signature-space"></div>
                    <p><strong>(${b.supervisorName || 'Pak Arif Nugroho, S.Kom'})</strong></p>
                    <p style="font-size: 0.78rem; color: #555;">NIP. 197001012000011000</p>
                </div>
                <div>
                    <p>Jakarta, ${new Date().toLocaleDateString('id-ID', { dateStyle: 'long' })}<br>Waka Bidang Sarpras,</p>
                    <div class="letter-signature-space"></div>
                    <p><strong>(${b.approvedBy !== '-' ? b.approvedBy : 'Pak Arif Nugroho, S.Kom'})</strong></p>
                    <p style="font-size: 0.78rem; color: #555;">NIP. 197007072000071006</p>
                </div>
            </div>
        `;

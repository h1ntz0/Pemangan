...
|---|---|---|---|---|
| `r-401` | Ruang 401 - Lab Komputer SIJA (Cloud & Network) | Lantai 4 | 36 Orang | Pak Arif Nugroho, S.Kom |
| `r-403` | Ruang 403 - Lab Rekayasa Perangkat Lunak & Database | Lantai 4 | 36 Orang | Pak Rian Kusuma, M.Kom |
| `r-405` | Ruang 405 - Lab Cyber Security & Fiber Optic | Lantai 4 | 32 Orang | Ibu Sari Wulandari, M.Pd |
| `r-teater` | Ruang 1 - Teater Audio Visual (Auditorium) | Gedung Utama (Lt 3) | 120 Orang | Ibu Dra. Ratna Sari |
...
| `r-podcast` | Studio Podcast & Broadcasting SMKN 1 | Gedung Utama (Lt 3) | 15 Orang | Pak Andi Saputra, S.Kom |
| `r-22` | Ruang 22 - Gedung Baru (Kelas Teori) | Gedung Baru (Lt 2) | 36 Orang | Pak Haris Maulana, S.Pd |
| `r-23` | Ruang 23 - Gedung Baru (Kelas Teori) | Gedung Baru (Lt 2) | 36 Orang | Ibu Sari Wulandari, M.Pd |
| `r-24` | Ruang 24 - Gedung Baru (Smart TV 65") | Gedung Baru (Lt 2) | 40 Orang | Pak Andi Saputra, S.Kom |
| `r-25` | Ruang 25 - Gedung Baru (Hybrid Class LAN) | Gedung Baru (Lt 2) | 36 Orang | Pak Dedi Kurniawan, S.T |
| `r-15` | Ruang 15 - Gedung Lama (Kelas Asri) | Gedung Lama (Lt 1) | 32 Orang | Ibu Sri Handayani, S.Pd |
| `r-16` | Ruang 16 - Gedung Lama (Organisasi Kesiswaan) | Gedung Lama (Lt 1) | 32 Orang | Pak Hendra Wijaya, S.Pd |
...
|---|---|---|---|
| **Siswa** | `000002` | `123` | Pengajuan reservasi 4-langkah & unduh surat izin resmi |
| **Guru** | `00000000` | `guru` | Pengajuan prioritas & akses Command Center Sarpras |
...
- **Pengembang:** Anisa Rahmawati & Bagas Pratama (XI SIJA 1 — SMK Negeri 1 Jakarta)

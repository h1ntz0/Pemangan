...
|---|---|---|---|
| **Siswa** | `000002` | `123` | Pengajuan reservasi & unduh surat izin |
| **Guru** | `00000000` | `guru` | Pengajuan dan akses Panel Kelola Sarpras |
...
- **Pengembang:** Anisa Rahmawati & Bagas Pratama (XI SIJA — SMK Negeri 1 Jakarta)

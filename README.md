...
|:---:|:---|:---|:---:|:---|:---|
| `r-401` | **Lab Komputer SIJA** | Lantai 4 | 36 Siswa | Pak Arif Nugroho, S.Kom | 36 PC Core i7, Mikrotik Router, Server Rack |
| `r-403` | **Lab Rekayasa Perangkat Lunak** | Lantai 4 | 36 Siswa | Pak Rian Kusuma, M.Kom | 36 PC Core i5, Dual Monitor, Smart Board |
| `r-405` | **Lab Cyber Security & Fiber Optic**| Lantai 4 | 32 Siswa | Ibu Sari Wulandari, M.Pd | Splicer Fiber Optic, OTDR, Cisco Switch |
| `r-teater` | **Ruang 1 - Teater Audio Visual** | Gedung Utama Lt 3 | 120 Kursi | Ibu Dra. Ratna Sari | Proyektor Laser 5000 Lumens, Sound Cinema |
...
| `r-podcast` | **Studio Podcast & Multimedia** | Gedung Utama Lt 3 | 15 Orang | Pak Andi Saputra, S.Kom | Mic Condenser Rode, Audio Mixer, Green Screen |
| `r-22` | **Ruang 22 - Kelas Teori Kejuruan** | Gedung Baru Lt 2 | 36 Siswa | Pak Haris Maulana, S.Pd | Whiteboard Kaca, Proyektor Fixed, AC Split |
| `r-23` | **Ruang 23 - Kelas Teori Reguler** | Gedung Baru Lt 2 | 36 Siswa | Ibu Sari Wulandari, M.Pd | Meja Siswa Standar Ergonomis, Audio Speaker |
| `r-24` | **Ruang 24 - Smart Classroom** | Gedung Baru Lt 2 | 40 Siswa | Pak Andi Saputra, S.Kom | Smart TV Interactive 65", Wireless Display |
| `r-25` | **Ruang 25 - Hybrid Network Class** | Gedung Baru Lt 2 | 36 Siswa | Pak Dedi Kurniawan, S.T | 36 Port Gigabit LAN, Gigabit Wi-Fi 6 AP |
| `r-15` | **Ruang 15 - Gedung Lama (Kelas Asri)**| Gedung Lama Lt 1 | 32 Siswa | Ibu Sri Handayani, S.Pd | Sirkulasi Udara Alami, Display Mading Kelas |
| `r-16` | **Ruang 16 - Ruang Organisasi (OSIS)**| Gedung Lama Lt 1 | 32 Siswa | Pak Hendra Wijaya, S.Pd | Meja Diskusi Rapat, Lemari Arsip Organisasi |
...
├────────────┼──────────────────┼─────────────┼──────────────────────────────────────────┤
│ 👨‍🎓 Siswa   │ 000002           │ 123         │ Reservasi 4 langkah, tracking, print slip│
│ 👨‍🏫 Guru    │ 00000000         │ 123         │ Pengajuan prioritas, pembimbing kegiatan │
...
|---|---|---|
| **Anisa Rahmawati** | Lead Frontend & UI/UX Engineer | XI SIJA 1 — SMKN 1 Jakarta |
| **Bagas Pratama** | System Architecture & Testing Engineer | XI SIJA 1 — SMKN 1 Jakarta |

- **Guru Pembimbing:** Pak Arif Nugroho, S.Kom

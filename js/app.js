        ...
        printableSlipContainer.innerHTML = `
            ...
            <div class="grid grid-cols-3 gap-2 text-center text-xs font-sans pt-2">
                ...
                <div>
                    <p>Guru Pendamping,</p>
                    <div class="h-12"></div>
                    <p class="font-bold underline">(${b.supervisorName || 'Pak Arif Nugroho, S.Kom'})</p>
                    <p class="text-[10px] text-slate-600">NIP. 197001012000011000</p>
                </div>
                <div>
                    <p>Waka Bidang Sarpras,</p>
                    <div class="h-12"></div>
                    <p class="font-bold underline">(${b.approvedBy !== '-' ? b.approvedBy : 'Pak Arif Nugroho, S.Kom'})</p>
                    <p class="text-[10px] text-slate-600">NIP. 197007072000071006</p>
                </div>
            </div>
        `;

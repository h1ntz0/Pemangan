...
export const StatusBadge: React.FC<{ status: BookingStatus | RoomStatus; size?: 'sm' | 'md' | 'lg' }> = ({ status, size = 'sm' }) => {
  switch (status) {
    ...
    case 'ongoing':
      return (
        <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-[11px] font-medium bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-950/60 dark:text-emerald-300 dark:border-emerald-900">

...
export const LoginPage: React.FC = () => {
  ...
  const [nis, setNis] = useState<string>('000002');
        ...
        <div className="p-6 sm:p-8 flex flex-col justify-between space-y-5">
          ...
          <form onSubmit={handleLogin} className="space-y-3.5">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                placeholder="000002 / 00000000 / admin"
          ...
          <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-1.5 text-xs">
              <button
                type="button"
                onClick={() => handleQuickDemo('siswa', '000002', '123')}
              ...
              >
                ...
                <span className="text-[10px] text-slate-500">NIS: 000002</span>
              </button>

              <button
                type="button"
                onClick={() => handleQuickDemo('guru', '00000000', '123')}
                className="p-2 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 text-center transition-colors"
              >
                <p className="font-semibold text-slate-900 dark:text-slate-100 text-xs">Guru</p>
                <span className="text-[10px] text-slate-500">NIP: 00000000</span>
              </button>

...
export const RoomDetailPage: React.FC = () => {
  ...
  if (!room) {
    return (
      <div className="py-20 text-center space-y-4">
        ...
        <p className="text-xs text-slate-500">ID ruangan yang dicari tidak terdaftar dalam katalog Sarpras.</p>
        <Link to="/rooms" className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-900 text-white text-xs font-bold">
  ...
  return (
    <div className="py-6 sm:py-10 space-y-8 animate-fadeIn max-w-5xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-xl">
        ...
        <div className="relative h-64 sm:h-80 w-full overflow-hidden bg-slate-100 dark:bg-slate-800">
          ...
          <div className="absolute top-4 left-4 right-4 flex items-center justify-between">
            <span className="px-3 py-1 rounded-xl text-xs font-bold bg-white/95 text-slate-900 shadow-md">
              {room.category}
            </span>
          ...
          <div className="absolute bottom-6 left-6 right-6 text-white space-y-1">
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold font-heading">{room.name}</h1>
        ...
        <div className="p-6 sm:p-8 space-y-8">
          ...
          <div className="space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
            ...
            {roomBookings.length > 0 ? (
              ...
              <p className="text-xs text-slate-500 italic p-4 bg-slate-50 dark:bg-slate-950 rounded-xl border">
                Belum ada permohonan reservasi untuk ruangan ini.
              </p>
            )}
          </div>
          ...
          <div className="pt-6 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between gap-4">
            <Link
              to="/rooms"
              className="px-5 py-3 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-bold text-slate-700 dark:text-slate-300"
            >
              Lihat Ruangan Lain
            </Link>
            ...
            <button
              ...
              className="px-6 py-3 rounded-xl bg-blue-900 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-500 text-white text-xs font-bold shadow-lg shadow-blue-900/20 flex items-center gap-2 transition-all transform hover:-translate-y-0.5"
            >
